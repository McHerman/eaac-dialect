module {
  func.func @compute(%0: tensor<16x16xi8>, %1: tensor<16x16xi8>, %2: tensor<16x16xi8>, %3: tensor<16x16xi8>, %4: tensor<16x16xi8>, %5: tensor<16x16xi8>, %6: tensor<16x16xi8>, %7: tensor<16x16xi8>, %8: tensor<16x16xi8>, %9: tensor<16x16xi8>, %10: tensor<16x16xi8>, %11: tensor<16x16xi8>, %12: tensor<16x16xi8>, %13: tensor<16x16xi8>, %14: tensor<16x16xi8>, %15: tensor<16x16xi8>, %16: tensor<16x16xi8>, %17: tensor<16x16xi8>, %18: tensor<16x16xi8>, %19: tensor<16x16xi8>, %20: tensor<16x16xi8>, %21: tensor<16x16xi8>, %22: tensor<16x16xi8>, %23: tensor<16x16xi8>) -> tensor<16x16xi8> {
    ...
    %bias = arith.constant dense<"0xA74E9B3127FCEE6796FEFB85AF0910DC3CC4E6A1C0E2EB12105A9B54FBDC449FC7F938FBF0F3501CC886FDC1B491A41F0E1741BBB20DAEC231DBB0B6D2B31C7D"> : tensor<16xi32>
    %biased_out = tensor.empty() : tensor<16x16xi32>
    %biased = linalg.generic {indexing_maps = [affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d1)>, affine_map<(d0, d1) -> (d0, d1)>], iterator_types = ["parallel", "parallel"]} ins(%sum_23, %bias : tensor<16x16xi32>, tensor<16xi32>) outs(%biased_out : tensor<16x16xi32>) {
    ^bb0(%a: i32, %b: i32, %o: i32):
      %s = arith.addi %a, %b : i32
      linalg.yield %s : i32
    } -> tensor<16x16xi32>

module attributes {
  ...
  func.func @main(%0: tensor<16x16xi8>, %1: tensor<16x16xi8>, %2: tensor<16x16xi8>, %3: tensor<16x16xi8>, %4: tensor<16x16xi8>, %5: tensor<16x16xi8>, %6: tensor<16x16xi8>, %7: tensor<16x16xi8>, %8: tensor<16x16xi8>, %9: tensor<16x16xi8>, %10: tensor<16x16xi8>, %11: tensor<16x16xi8>, %12: tensor<16x16xi8>, %13: tensor<16x16xi8>, %14: tensor<16x16xi8>, %15: tensor<16x16xi8>) -> tensor<16x16xi8> {
    ...
    %bias = arith.constant dense<"0xCCAF265BF3A0B56F895D61FF66787B876975677FB64F363D28FC0315F6BEA1FC8CFB5D8FCB71411BD8F410B1C959EA3DEBA104066BC233A6B9845F867989F1AF"> : tensor<16xi32>
    %biased_out = tensor.empty() : tensor<16x16xi32>
    %biased = linalg.generic {indexing_maps = [affine_map<(d0, d1) -> (d0, d1)>, affine_map<(d0, d1) -> (d1)>, affine_map<(d0, d1) -> (d0, d1)>], iterator_types = ["parallel", "parallel"]} ins(%sum_15, %bias : tensor<16x16xi32>, tensor<16xi32>) outs(%biased_out : tensor<16x16xi32>) {
    ^bb0(%a: i32, %b: i32, %o: i32):
      %s = arith.addi %a, %b : i32
      linalg.yield %s : i32
    } -> tensor<16x16xi32>
